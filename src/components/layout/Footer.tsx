    ...
    <footer className="pt-16 pb-12 px-6 border-t border-black/[0.06] dark:border-white/[0.06] bg-[#FAF8F5] dark:bg-[#11100F] transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col divide-y divide-black/[0.06] dark:divide-white/[0.06] md:divide-y-0 md:grid md:grid-cols-2 lg:grid-cols-12 md:gap-10 lg:gap-8 pb-12 border-b border-black/[0.06] dark:border-white/[0.06]">
          ...
          {/* Col 2: Navegação Rápida com Touch Targets Otimizados */}
          <div className="py-6 md:py-0 md:col-span-1 lg:col-span-2">
            ...
            <ul className="flex flex-col text-xs text-on-surface-variant dark:text-slate-400 font-light">
              <li>
                <a
                  href="#inicio"
                  className="py-2 inline-flex items-center min-h-[40px] hover:text-accent transition-colors focus:outline-hidden focus-visible:ring-1 focus-visible:ring-accent rounded-xs"
                >
                  Início
                </a>
              </li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-text-secondary dark:text-slate-500 font-light text-center sm:text-left">
          <p>
