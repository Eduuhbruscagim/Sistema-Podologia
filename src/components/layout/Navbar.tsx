      ...
      >
        <div className="max-w-6xl mx-auto px-3 sm:px-6 h-18 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-3 shrink-0">
            ...
            <div className="lg:hidden flex items-center">
              <button
                ...
                className="min-w-[44px] min-h-[44px] shrink-0 flex items-center justify-center rounded-full text-text-secondary hover:text-accent dark:hover:text-accent hover:bg-black/5 dark:hover:bg-white/5 transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-accent cursor-pointer"
                aria-label={
          ...
          <div className="flex items-center gap-1 sm:gap-2.5 shrink-0">
            ...
            {/* CTA Primário: Rola suavemente até Procedimentos */}
            <a
              href="#procedimentos"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <a
              href="#procedimentos"
              onClick={() => setIsMobileMenuOpen(false)}
              className="px-4 py-3 min-h-[44px] rounded-lg text-xs uppercase tracking-[0.16em] font-medium text-on-surface hover:text-accent dark:hover:text-accent hover:bg-black/5 dark:hover:bg-white/5 transition-colors flex items-center focus:outline-hidden focus-visible:ring-2 focus-visible:ring-accent"
            >
              Procedimentos
            </a>
            <a
