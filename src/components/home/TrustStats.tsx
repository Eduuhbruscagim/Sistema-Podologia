  ...
  return (
    ...
    >
      ...
      <dl className="grid grid-cols-1 md:grid-cols-2 rounded-xl border border-surface-border bg-pure-white dark:bg-surface-variant overflow-hidden">
        {/* Célula 1: Destaque de Atendimentos (+25.000) */}
        <div className="stat-block col-span-1 bg-pure-white dark:bg-surface-variant border-b md:border-b-0 md:border-r border-surface-border p-6 sm:p-8 lg:p-10 flex flex-col justify-center transition-colors duration-200">
        ...
        {/* Célula 2: Deslocamento Cortesia (Taxa R$ 0) */}
        <div className="stat-block col-span-1 bg-pure-white dark:bg-surface-variant p-6 sm:p-8 lg:p-10 flex flex-col justify-center transition-colors duration-200">
          <div className="stat-reveal flex flex-col justify-center">
