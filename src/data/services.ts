...
export const SERVICES: ServiceItem[] = [
  {
    ...
    features: [
      'Corte certinho pra não encravar',
      'Tiro a cutícula e passo esmalte',
      'Lixo a sola do pé e hidrato',
      'Secagem na cabine (pra não borrar)',
    ],
    icon: 'sparkles',
  },
  {
    ...
    features: [
      'Corte certinho pra não encravar',
      'Cuidado especial para pé diabético',
      'Removo calos sem machucar',
      'Lixo a sola e hidrato bem',
      'Passo esmalte (se você quiser)',
    ],
    icon: 'footprints',
  },
  {
